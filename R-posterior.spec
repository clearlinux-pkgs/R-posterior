...
Version  : 1.6.1
Release  : 23
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/posterior_1.6.1.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/posterior_1.6.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740701879
...
/usr/lib64/R/library/posterior/doc/pareto_diagnostics.R
/usr/lib64/R/library/posterior/doc/pareto_diagnostics.Rmd
/usr/lib64/R/library/posterior/doc/pareto_diagnostics.html
...
/usr/lib64/R/library/posterior/tests/testthat/test-extract_variable_array.R
